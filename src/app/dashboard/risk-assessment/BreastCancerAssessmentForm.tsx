              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    type="number"
                    placeholder="Years"
                    label="Have you used hormone replacement therapy (HRT), If yes, how many years have you used it? — HRT includes estrogen-only or combined estrogen and progesterone but does not include hormonal birth control."
                    labelStyle="lg:text-sm text-xs"
                    min={0}
                    disabled={disabled}
                  />
