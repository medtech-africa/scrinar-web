...
import { ExportAsExcelParent } from '../export-excel'
  ...
  const formattedData = useMemo(
    () =>
      data?.map((parentData: any) => {
        const latestHealthData = parentData?.parent?.latestHealthData ?? {}
        return {
          ...
          familyCode: parentData?.familyCode || parentData?.parent?.familyCode,
          isGuardian:
            parentData?.isGuardian ?? parentData?.parent?.isGuardian ?? '-',
          ...
          // dietaryDiversityHoursOnComputer:
          //   data?.dietaryDiversity?.hoursOnComputer,
          // dietaryDiversityHoursOnTv: data?.dietaryDiversity?.hoursOnTv,
          // dietaryDiversityHoursOnSleep: data?.dietaryDiversity?.hoursOnSleep,
          // dietaryDiversitySportQuestion: data?.dietaryDiversity?.sportQuestion,
          // dietaryDiversitySchoolTransportQuestion:
          //   data?.dietaryDiversity?.schoolTransportQuestion,
          // physicalActivityFruitsTimesFish:
          //   data?.physicalActivity?.fruitsTimes?.fish,
          // physicalActivityFruitsTimesFriedFood:
          //   data?.physicalActivity?.fruitsTimes?.friedFood,
          // physicalActivityFruitsTimesSugar:
          //   data?.physicalActivity?.fruitsTimes?.sugar,
          // physicalActivityFruitsTimesPastries:
          //   data?.physicalActivity?.fruitsTimes?.pastries,
          // physicalActivityFruitsTimesSweets:
          //   data?.physicalActivity?.fruitsTimes?.sweets,
          // physicalActivityFruitsTimesCarbohydrates:
          //   data?.physicalActivity?.fruitsTimes?.carbohydrates,
          // physicalActivityFruitsTimesEgg:
          //   data?.physicalActivity?.fruitsTimes?.egg,
          // physicalActivityFruitsTimesFruits:
          //   data?.physicalActivity?.fruitsTimes?.fruits,
          // physicalActivityFruitsTimesMeat:
          //   data?.physicalActivity?.fruitsTimes?.meat,
          // physicalActivityFruitsTimesVegetable:
          //   data?.physicalActivity?.fruitsTimes?.vegetable,
          // physicalActivityMealsPerDay: data?.physicalActivity?.mealsPerDay,
          // physicalActivityFoodAmount: data?.physicalActivity?.foodAmount,
          // physicalActivityDietary: data?.physicalActivity?.dietary,
          isEmergency: latestHealthData?.isEmergency,
          // health data end
          ...
          genderHouseholdRole: {
            ...
            education_decision_responsibility:
              parentData?.genderHouseholdRole
                ?.education_decision_responsibility,
          ...
          nutrition: {
            ...
            anyFamilyMemberWithNcd:
              parentData?.nutrition?.anyFamilyMemberWithNcd,
            ...
            effectsOfTooMuchSweets:
              parentData?.nutrition?.effectsOfTooMuchSweets,
          ...
          riskyBehavior: {
            ...
            stressOther: parentData?.riskyBehavior?.stressOther,
            thingsDoneToChildToEaseWorryUpset:
              parentData?.riskyBehavior?.thingsDoneToChildToEaseWorryUpset?.join(
                ', '
              ),
            feelingsOfstress: parentData?.riskyBehavior?.feelingsOfstress,
            whenAdolescentsExposedToSmoking:
              parentData?.riskyBehavior?.whenAdolescentsExposedToSmoking,
          },
          ...
          ncdRiskFactor: {
            work: {
              ...
              vigorousActivity:
                parentData?.ncdRiskFactor?.work?.vigorousActivity,
            ...
            alcohol: {
              ...
              drinks: {
                ...
                homebrewedBeerWine:
                  parentData?.ncdRiskFactor?.alcohol?.drinks
                    ?.homebrewedBeerWine,
                nonDrinkableAlcohol:
                  parentData?.ncdRiskFactor?.alcohol?.drinks
                    ?.nonDrinkableAlcohol,
            ...
            smoking: {
              ...
              pastTobaccoUse:
                parentData?.ncdRiskFactor?.smoking?.pastTobaccoUse,
              pastDailySmoking:
