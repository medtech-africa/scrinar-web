...
export const ReligionPieChart = () => {
  const { data } = useChildrenAnalytics()
  const childrenData = data?.data
  if (!childrenData) return null
  console.log(childrenData, 'Children Data')

  return
  const formattedResult = getTypeDistribution(childrenData, 'religion')
...
const ChildrenAnalytics = () => {
  const { data } = useChildrenAnalytics()
  const childrenData = data?.data
  console.log(childrenData, 'Children Datall')
  return (
